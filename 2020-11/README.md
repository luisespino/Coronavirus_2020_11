...
Alvarado Kevin, Cardona Berny, Galicia Nery, Giron Gary, Guarchaj Ottoniel, Hernandez Fernando Antonio, Hevia Eduardo, Lemus Yoselin, Lizama Luis, Melgar James, Morales Mario, Ordoñez Bryan, Solares Cesar, Vega Daniel, Veliz Jorge, Villatoro Kherson, Solares Omar, Lopez Abner. (students)
...
The public information about Covid situation in Guatemala country, found on the [Official Government website](https://tablerocovid.mspas.gob.gt/), contains different amount of data classified by 'Confirmed cases per town and date of issuance of results', 'Confirmed cases per town and symptom onset date', 'Screened cases per town and date of issuance of results', 'Screened cases per town and symptom onset date', and so on.

There are different tools, that are part of Machine Learning, useful for analizyng these data. k-means clustering is one of this tools, used to find anomalies on data sets. By anomaly we mean a value that doesn't follow the data set trend and it may occur for many factors: human errors, for example. 
...
![201114705_1](img/201114705_1.png)

The graph above shows the values on a plane. 

The next graph shows the data arranged on three clusters, each cluster associated with one colour. 

![201114705_2](img/201114705_2.png)

The next graph shows the centroids obtanied with the library.


![201114705_3](img/201114705_3.png)


![201114705_3](img/201114705_4.png)

And the last one graph shows all previous graphs togheter. 
We can identify al least six anomalies. This may occur for many factors like screening time, human error as we said before, and many more.
